/**
 * Measures .kismeta-header-wrap height and writes it to --kismeta-nav-offset so that
...
function initNavOffset() {
	...
	// Re-measure whenever the header resizes (viewport change, content reflow, etc.)
