---
title: "Printable Rulebook"
description: "Core rules for Kismeta — Alchemists of the Great Year. Print or save as PDF."
sidebar:
  hidden: true
pagefind: false
prev: false
...
<div class="print-guide print-guide--rulebook">
...
- Setup
- Round at a Glance
- The Cosmic Age (Spring, Summer, Autumn, Winter)
- Winning the Game
...
- **Crucible Card Deck** (22 cards, red back: Groups A, B, C, and D; 4 per player, per game)
...
- **1 Meeple** (marks your current Zodiac Sign on the board)
- **4 Astral Houses** (small wooden cylinder token)

**Tokens & Resources**

- **6 Coal** per player (wooden discs in each player's color; fuel for the Furnaces)
- **Reagents** (punchout tokens, one type per Element): Sulfur (Fire) | Vitriol (Earth) | Quicksilver (Air) | Aqua Regia (Water)
...
- **The Bazaar.** A shared reference area on the board. It lists every fixed exchange rate in the game.
...
**1️⃣ QUICKPLAY / FIRST PLAY** — _Recommended for first playthroughs._ Weighted toward Group A and B Crucible Cards. Expect 1 to 2 hours.

**2️⃣ STANDARD GAME** — _Recommended once you are familiar with the rules and the flow of an Age._ A balanced spread across all four Card Groups. Expect 2 to 3 hours.

**3️⃣ MAGNUS ALCHEMIST (MASTERY)** — _For returning players who seek a greater challenge._ Weighted toward Group C and D Crucible Cards. Expect 3 hours or more.
...
- Choose a builder below (Curated Builds, or Random Build). Follow the table to determine how many cards to draw from each Group for your player count.
...
- Return any unused Crucible Cards to the box.

**Curated Builds (Preset Difficulty Levels)**

| GAME MODE ➡️             | 1️⃣ QUICKPLAY |       |       |       | 2️⃣ STANDARD |       |       |       | 3️⃣ MAGNUS ALCHEMIST |       |       |       |
| ------------------------ | ------------- | ----- | ----- | ----- | ------------ | ----- | ----- | ----- | ------------------- | ----- | ----- | ----- |
...
**Random Build: Let The Fates Decide**

1. Shuffle all 22 Crucible Cards together.
2. Blindly draw four cards for each player in the game.
...
📌 **Resolve Fateful Wagers:** if any player placed a Fateful Wager during the previous Winter, resolve it now against the Sign just rolled.
...
Your **Tableau** is everything you have in play, arranged across three zones: the Spread, the Hand, and the Arcanum.

**Spread** — Cards played face up. Their effects are active; they may be used in card sets for Crafting and contribute to Harvests in Autumn. They can be lost in Duels.

**Hand** — Cards held privately. Their effects are inactive, and they cannot be used in card sets for Crafting. They are safe from Duels, and can be played in Sieges.

**Arcanum** — Your active Major Arcana cards. Fate Cards resolve at once and some carry an effect lasting until Transit. Adept Cards must be purchased for 3 Essence (limit two) and persist across Ages.
...
📌 **Spring is complete.** Proceed to **Phase 2: ☀️ Summer**.
...
Astral Houses are permanent structures built on the Zodiac Wheel. Only one player may build on any given Sign.
...
| Permanence           | Once placed, a House stays on the Sign where it was built and keeps working no matter what your Zodiac Die shows in later Ages. Ownership can change through Trade, but the House itself never moves. |
...
A Mansion doubles its Alignment score at the Harvest and in a Siege.
...
Certain cards let you extinguish a rival's Coal, removing it from a Furnace and lowering their Heat by 1 in that Element. The Coal returns to its owner's personal supply. Other cards Ward your Coal against being extinguished.
...
**Shield Reagents** — When you Fire your Stone, commit up to 3 Reagents as Shield Reagents. A rival must match them to attack.
...
Your Harvest Sources are your **Zodiac Die**, your **Astral Houses**, your **Adept Cards**, and your **Spread Cards**. Compare each source to the Cosmic Age and find matching Aspects.

1. **Tally your Harvest.** Compare the Aspects of each Harvest Source to the Aspects of the Cosmic Age.
2. **Stack every match.** If a source matches more than one Aspect, add every tier it matches. A Perfect Match scores the full stack of +6.
...
The four Furnaces prepare your Stone for each Transmutation Stage. Each Furnace holds three Coal, shared among all players and claimed first come, first served.

1. **Craft your Coal.** Spend 3 cards of one suit from your Spread, matching the Element of the Furnace you may fuel, to craft 1 Coal.
2. **Place your Coal** in the Furnace matching the Element of your Sign for this Age.
3. **Raise your Heat.** Each Coal you place raises your own **Heat** by +1 in that Element.
...
💡 **Example:** your Sign this Age is Leo, a Fire Sign, so the Fire Furnace is the one you may fuel. You spend three Wands from your Spread to craft 1 Coal, and place it in the Fire Furnace. Your Heat in Fire is now Kindled.
...
Cards are now unlocked. Rearrange them freely between your Hand and your Spread before taking any other Winter action.

**2️⃣ Fateful Wager 🃏** _(OPTIONAL)_
