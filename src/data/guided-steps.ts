...
const GUIDED_STEPS: Record<GuidedLocale, GuidedStep[]> = {
	en: [
		...
		},
		{
			...
			phaseStep: 1,
			phaseTotal: 1,
			body: '<p>Autumn follows a fixed sequence. The Agekeeper oversees the Forge while each player acts in turn order.</p><p>Select where your Philosopher\'s Stone is below to see which beats apply to you — the table still runs all four steps in order.</p>',
			embed: 'autumn-flow',
			learnMorePath: 'play/round-overview',
	...
	'pt-br': [
		...
		},
		{
			...
			phaseStep: 1,
			phaseTotal: 1,
			body: '<p>O Outono segue sequência fixa. O Guardião supervisiona a Forja enquanto cada jogador age na ordem de turno.</p><p>Selecione abaixo onde está sua Pedra do Filósofo para ver quais momentos se aplicam a você — a mesa ainda resolve os quatro passos em ordem.</p>',
			embed: 'autumn-flow',
			learnMorePath: 'play/round-overview',
