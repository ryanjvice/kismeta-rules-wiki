...
const GUIDED_STEPS: Record<GuidedLocale, GuidedStep[]> = {
  ...
  "pt-br": [
    ...
    },
    {
      ...
      phaseStep: 1,
      phaseTotal: 1,
      body: "<p>O Outono tem <strong>duas passagens</strong> na mesa: Passo 1 (Sair da Estase e Oposição em cada turno), depois Passo 2 (Temperar e Forjar após todos terminarem o Passo 1).</p><p>Selecione abaixo onde está sua Pedra do Filósofo para destacar os momentos do seu turno.</p>",
      embed: "autumn-flow",
      learnMorePath: "play/round-overview",
