    ...
    .map((step) => {
      ...
      if (step.id === "spring-4") {
        return {
          ...step,
          body:
            "<p>Your <strong>Tableau</strong> is everything you have in play, arranged across three zones.</p><p><strong>Spread</strong> — Minor Arcana played face-up. Effects are active; cards craft Coal, pay Attunements, form Stelliums, and score at the Harvest. They can be lost in Duels.</p><p><strong>Hand</strong> — Minor Arcana held privately. Effects are inactive; Hand cards are safe from Duels and may be committed in Sieges.</p><p><strong>Arcanum</strong> — Major Arcana (Fates and Adepts). You may hold up to two Adept Cards.</p><p>See <button type=\"button\" class=\"guided-play__inline-ref\" data-playtest-rule data-rules-path=\"rules/major-arcana\" data-rules-sections=\"fate-cards,adept-cards\" data-rules-title=\"Fate &amp; Adept Cards\">Fate &amp; Adept cards</button> and <button type=\"button\" class=\"guided-play__inline-ref\" data-playtest-rule data-rules-path=\"rules/minor-arcana\" data-rules-scope=\"page\" data-rules-title=\"Minor Arcana\">Minor Arcana</button>.</p>",
        };
      }
      return step;
    });
